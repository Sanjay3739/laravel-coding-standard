                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            <h1>Hi Sanjay,</h1>
                                            <p>You recently requested to reset your password for your [Product Name]
           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <a href="{{ $link }}"
                                                                        class="f-fallback button button--green">Reset
                                                                        your password</a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                            ...
                                            <p>For security, this request was received from a
                                                device using. If you did not request a password reset,
                                                please ignore this email or <a>contact
